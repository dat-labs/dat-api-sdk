...
class Data(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["document_chunk", "vectors", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of document_chunk
        if self.document_chunk:
            _dict['document_chunk'] = self.document_chunk.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "document_chunk": DocumentChunk.from_dict(obj["document_chunk"]) if obj.get("document_chunk") is not None else None,
            "vectors": Vectors.from_dict(obj["vectors"]) if obj.get("vectors") is not None else None,
            "metadata": DataMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
