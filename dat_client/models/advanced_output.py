...
class AdvancedOutput(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of splitter_settings
        if self.splitter_settings:
            _dict['splitter_settings'] = self.splitter_settings.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "splitter_settings": SplitterSettings.from_dict(obj["splitter_settings"]) if obj.get("splitter_settings") is not None else None
        })
        return _obj
