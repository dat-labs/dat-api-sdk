...
class ActorInstanceGetResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["workspace_id", "actor_id", "user_id", "name", "actor_type", "status", "configuration", "id", "actor", "connected_connections"]
