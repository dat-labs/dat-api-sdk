...
[**get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get**](ConnectionRunLogsApi.md#get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get) | **GET** /connection-run-logs/{connection_id}/agg-run-logs | Get Agg Run Logs
...
# **get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get**
> object get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get(connection_id, workspace_id)
...
with dat_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Agg Run Logs
        api_response = api_instance.get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get(connection_id, workspace_id)
        print("The response of ConnectionRunLogsApi->get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ConnectionRunLogsApi->get_agg_run_logs_connection_run_logs_connection_id_agg_run_logs_get: %s\n" % e)
```
...
> List[ConnectionRunLogResponse] get_connection_run_logs_connection_run_logs_connection_id_runs_get(connection_id, workspace_id)
...
with dat_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Connection Run Logs
        api_response = api_instance.get_connection_run_logs_connection_run_logs_connection_id_runs_get(connection_id, workspace_id)
...
> List[ConnectionRunLogResponse] get_connection_runs_by_run_id_connection_run_logs_runs_run_id_get(run_id, workspace_id)
...
with dat_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Connection Runs By Run Id
        api_response = api_instance.get_connection_runs_by_run_id_connection_run_logs_runs_run_id_get(run_id, workspace_id)
